...
public class ActivistaDAO implements IActivistaDAO{
    ...
    public boolean insertar(Activista activista) {
        ...
        PreparedStatement ps = con.prepareStatement(sql)){
            ...
            System.err.println("Error al insertar activista: " + ex.getMessage());
            return false;
        }
    }
    ...
    public Activista obtenerPorId(int idActivista) {
        ...
        PreparedStatement ps = con.prepareStatement(sql)){
            ...
            System.err.println("Error al obtener activista por id: " + ex.getMessage());
        }
        return activista;
    }
    ...
    public List<Activista> obtenerTodos() {
        ...
        ResultSet rs = ps.executeQuery()){
            ...
            System.err.println("error al obtener todos los activistas: " + ex.getMessage());
        }
        return lista;
    }
    ...
    public boolean eliminar(int idActivista) {
        ...
        PreparedStatement ps = con.prepareStatement(sql)){
            ...
            System.err.println("Error al eliminar activista: " + ex.getMessage());
            return false;
        }
    }
