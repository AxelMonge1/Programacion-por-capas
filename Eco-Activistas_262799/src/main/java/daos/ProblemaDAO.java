...
public class ProblemaDAO implements IProblemaDAO{
    ...
    public boolean insertar(Problema problema) {
        String sql = "INSERT INTO Problema (fch_ini, fch_fin, estado, isCliente) VALUES (?, ?, ?, ?)";
        ...
        PreparedStatement ps = con.prepareStatement(sql)){
            ...
            System.err.println("Error al insertar el problema: " + ex.getMessage());
            return false;
        }
    }
    ...
    public Problema obtenerPorId(int idProblema) {
        ...
        PreparedStatement ps = con.prepareStatement(sql)){
            ...
            System.err.println("Error al obtener problema por id: " + ex.getMessage());
        }
        return problema;
    }
    ...
    public List<Problema> obtenerTodos() {
        ...
        ResultSet rs = ps.executeQuery()){
            ...
            System.err.println("Error al obtener todos los problemas: " + ex.getMessage());
        }
        return lista;
    }
    ...
    public boolean actualizar(Problema problema) {
        String sql = "UPDATE´Problema SET fch_ini = ?, estado = ?, idClioente = ? WHERE idProblema = ?";
        try(Connection con = ConexionDB.getConnection();
        PreparedStatement ps = con.prepareStatement(sql)){
            ps.setDate(1, problema.getFchIni());
            ps.setDate(2, problema.getFchFin());
            ...
            System.err.println("Error al actualizar el problema: " + ex.getMessage());
            return false;
        }
    }
    ...
    public boolean eliminar(int idProblema) {
        ...
        PreparedStatement ps = con.prepareStatement(sql)){
            ...
            System.err.println("Error al eliminar el problema: " + ex.getMessage());
            return false;
        }
    }
